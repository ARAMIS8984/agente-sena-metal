...
def llamado_generar_pdf(chat_id):
    ...
    try:
        # Agregar nombre completo del programa al estado
        prog_key = estado.get('programa', 'CNC')
        estado['programa_nombre'] = PROGRAMAS_NOMBRES.get(prog_key, prog_key)
        pdf_bytes = generar_pdf_llamado_oficial(estado)
